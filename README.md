...
```bash
./vacinas_cli.py --chart doses --start-year 2023 --end-year 2024 --top 10 -o ex_doses_brasil.png
```
...
```bash
./vacinas_cli.py --chart monthly --start-year 2023 --end-year 2024 --state RS --search Influenza COVID HPV -o ex_mensal_rs.png
```
...
```bash
./vacinas_cli.py --chart complications --severity severe --sort most_complications --start-year 2023 --end-year 2024 --until HPV Influenza -o ex_complicacoes_until.png
```
...
```bash
./vacinas_cli.py --chart complications --severity severe --sort most_complications --start-year 2023 --end-year 2024 --top 5 --search Dengue -o ex_complicacoes_search_dengue.png
```
...
```bash
./vacinas_cli.py --chart profile --start-year 2023 --end-year 2024 --search Dengue -o ex_perfil_dengue.png
```
